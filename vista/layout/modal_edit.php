                        ...
                        <tr>
                            <th class="cabecera_tabla">
                                ...
                                <div style="display:flex;justify-content:center;" >
                                    <select class="form-select form-select-sm" aria-label="Small select example" style="width: 120px;" >
